...
-- ============================================
-- BẢNG 1B: admins - Danh sách quản trị viên
-- ============================================
CREATE TABLE IF NOT EXISTS admins (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL UNIQUE COMMENT 'Khóa ngoại trỏ về bảng users',
    role_name VARCHAR(50) NOT NULL DEFAULT 'Admin' COMMENT 'Vai trò hiển thị (mặc định Admin)',
...
COMMENT='Bảng lưu danh sách tài khoản quản trị (tham chiếu tới users)';

-- Tạo admin mặc định nếu chưa có (email: admin@smartexpense.com, mật khẩu: Admin@123)
...
CREATE TABLE IF NOT EXISTS categories (
    ...
    -- Thêm các trường mới: color, note, is_active
    color VARCHAR(7) DEFAULT '#3b82f6' COMMENT 'Màu sắc (hex, ví dụ: #3b82f6)',
    note TEXT NULL COMMENT 'Ghi chú cho danh mục',
    is_active BOOLEAN DEFAULT TRUE COMMENT 'Trạng thái: TRUE = BẬT, FALSE = TẮT',
...
-- ============================================
-- BẢNG 9: devices - Quản lý thiết bị đăng nhập
-- ============================================
